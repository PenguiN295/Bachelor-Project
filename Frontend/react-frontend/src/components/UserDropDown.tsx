  ...
  return(
     <div className="dropdown d-inline-block">
            ...
            <ul className="dropdown-menu dropdown-menu-end w-100 shadow-sm" aria-labelledby="userMenuButton" style={{ minWidth: '100%' }}>
                <li>
                    <button className="dropdown-item text-danger fw-semibold" onClick={onLogoutClick} style={{ minWidth: '100%' }}>
                        <i className="bi bi-box-arrow-right"></i>
                        Logout
                    </button>
                    <button className="dropdown-item text-primary fw-semibold" onClick={onProfileClick} style={{ minWidth: '100%' }}>
